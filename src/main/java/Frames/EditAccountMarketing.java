 ...
 */
public class EditAccountMarketing extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            if(x.updateMarketing(Integer.parseInt(jTextFieldID.getText()),x)) {
            ...
            Logger.getLogger(EditAccountMarketing.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        MarketingEmployee x = new MarketingEmployee();
                ...
                try {
                    if (x.verifyMarketingLogin(jTextFieldUU.getText(), jPasswordFieldPP.getText()))
                    {  returned = x.searchMarketing(jTextFieldUU.getText())  ;setPanelData(returned); }
                    else
