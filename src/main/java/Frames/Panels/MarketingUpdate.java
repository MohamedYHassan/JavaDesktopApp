 ...
 */
public class MarketingUpdate extends javax.swing.JPanel {
    ...
    int oldId;
      ...
      protected void setPanelData(MarketingEmployee x) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        jLabelSuccessFail.setText("");
         if(!jTextFieldSearch.getText().equals("")) {
            ...
            MarketingEmployee returned = null;
            try {
                returned = x.searchMarketing(Integer.parseInt(jTextFieldSearch.getText()));
            } catch (ParseException ex) {
                Logger.getLogger(MarketingUpdate.class.getName()).log(Level.SEVERE, null, ex);
            }
            if (returned != null) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(!jTextFieldSearch.getText().equals("")) {
            MarketingEmployee x = new MarketingEmployee();
            try {
                if(x.deleteMarketing(Integer.parseInt(jTextFieldSearch.getText()))) {
