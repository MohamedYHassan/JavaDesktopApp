 ...
 */
public class EditAccountSales extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
           ...
           if(x.updateSales(Integer.parseInt(jTextFieldID.getText()),x)) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      ...
      Seller x = new Seller();
                ...
                try {
                    if (x.verifySalesLogin(jTextFieldUU.getText(), jPasswordFieldPP.getText()))
                    {  returned = x.searchSales(jTextFieldUU.getText())  ;setPanelData(returned); }
                    else
