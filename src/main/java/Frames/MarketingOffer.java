 ...
 */
public class MarketingOffer extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         ...
         if(!jTextFieldPID.getText().equals("") && !jTextFieldOID.getText().equals("") && !jTextFieldOffer.getText().equals("")) {
           
             Offer x = new Offer();
              Products y = new Products();
            
             x.setOfferID(Integer.parseInt(jTextFieldOID.getText()));
              ...
              if(pReturned != null) {
                 x.setProductID(Integer.parseInt(jTextFieldPID.getText()));
                            ...
                            x.setOffer(jTextFieldOffer.getText());
                             if(x.addOffer()) {
